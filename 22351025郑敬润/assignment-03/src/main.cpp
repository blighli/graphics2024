...
int main()
{
    ...
    // -------------------------
    Shader modelShader((std::filesystem::path(PROJECT_SOURCE_DIR) / "res" / "shaders" / "object.vs").generic_string().c_str(), (std::filesystem::path(PROJECT_SOURCE_DIR) / "res" / "shaders" / "object.fs").generic_string().c_str());
    Shader lampShader((std::filesystem::path(PROJECT_SOURCE_DIR) / "res" / "shaders" / "lamp.vs").generic_string().c_str(), (std::filesystem::path(PROJECT_SOURCE_DIR) / "res" / "shaders" / "lamp.fs").generic_string().c_str());
