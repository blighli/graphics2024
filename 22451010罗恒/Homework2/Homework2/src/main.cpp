...
int main()
{
	...
	Shader earthShader("shader/renderEarthMoon.vert", "shader/renderEarthMoon.frag");

	//texture
	uint32_t sunTex = getTexID("resource/sun.jpg");
	uint32_t earthTex = getTexID("resource/earth.jpg");
	uint32_t moonTex = getTexID("resource/moon.jpg");
	sphereShader.use();
