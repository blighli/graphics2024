...
class Minecraft(pyglet.window.Window):
    ...
    def __init__(self, win_size=(800, 600)):
        ...
        self.menu_bg_img = pyglet.image.load('resources/background.png')
        ...
        self.logo_img = pyglet.image.load('resources/logo.png')
        ...
        self.play_btn_img = pyglet.image.load('resources/button.png')
        ...
        self.loading_bg_img = pyglet.image.load('resources/loading_bg.png')
        ...
        self.load_btn_text = pyglet.text.Label('Load Game',
            font_name='Minecraftia',
            font_size=16,
            x=self.WIN_SIZE[0]//2, y=self.load_btn.position[1] + 20,
            anchor_x='center', anchor_y='center')

        self.controls_btn_text = pyglet.text.Label('Instructions',
            font_name='Minecraftia',
            font_size=16,
        ...
        self.blockMaterial = Material("resources/tex_array_1.png", isArr=True)
    ...
    def set_exclusive(self, val=True):
        if val == True:
            super(Minecraft, self).set_exclusive_mouse(False)
            super(Minecraft, self).set_exclusive_mouse(True)
            self.exclusive = True
        else:
            super(Minecraft, self).set_exclusive_mouse(False)
