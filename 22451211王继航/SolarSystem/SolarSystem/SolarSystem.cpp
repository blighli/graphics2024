...
int main() {
    ...
    unsigned int earthTexture = loadTexture("assets\\earth.jpg");
    glActiveTexture(GL_TEXTURE2);
    glBindTexture(GL_TEXTURE_2D, earthTexture);
    unsigned int moonTexture = loadTexture("assets\\moon.jpg");
    ...
    float sun_d = 6.0f;
    float sun_rotate = 25.0f * 24.0f;
    float sun_earth_len = 18.0f;
    float earth_d = 2.0f;
    float earth_rotate = 1.0f * 24.0f;
    float earth_sun_rotate = 365.0f * 24.0f;
    float moon_earth_len = 6.0f;
    float moon_d = 0.5f;
    float moon_rotate = 27.0f * 24.0f;
    float moon_earth_rotate = 27.0f * 24.0f;
